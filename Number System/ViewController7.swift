...
class ViewController7: UIViewController {
    ...
    @IBAction func AddNow(_ sender: Any) {
        ...
        if InputNumber1.text!.isBinaryNumber == false{
            ...
            let Number1 = Int(InputNumber1.text!)
            let Number2 = Int(InputNumber2.text!)
            var BinaryArray1 = Number1!.Array
            var BinaryArray2 = Number2!.Array
            if BinaryArray2.count > BinaryArray1.count{
                let BinaryArray3 = BinaryArray1
                BinaryArray1 = BinaryArray2
                BinaryArray2 = BinaryArray3
            }
            ...
            while size2 > 0{
                HoldNumber = carryNumber + BinaryArray1[0]
                size2 -= 1
                if HoldNumber == 2{
                    NextNumber = 0
                    carryNumber = 1
